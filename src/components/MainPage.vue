        ...
        <div class="flex bg-blue-100">
            ...
            <main class="flex-1 p-4">
                ...
                <div v-if="currentTab === 'tasks'">
                    <TasksListVue v-bind:tasks="tasks" v-bind:nowIndex="nowIndex" />
                </div>
                ...
                <div v-if="currentTab === 'transactions'">
                    <TasksComponentVue v-bind:transactions="transactions" v-bind:nowIndex="nowIndex"/>
                </div>
                <router-view />
            </main>
        </div>
...
<script>
    ...
    import TasksComponentVue from "./TasksComponent.vue";
